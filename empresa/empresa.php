    ...
    <br>
        ...
        <div class="row">
          <div class="col-xs-6 col-md-3" >
            <a href="buscar_empresa.php"  class="thumbnail" >
             <h5>Buscar empresa</h5>
              <img src="../img/buscar.png" alt="empresa" >
            </a>
          </div>
          
          <div class="col-xs-6 col-md-3" >
            <a href="visualizar_empresa.php"  class="thumbnail" >
             <h5>Visualizar empresas</h5>
              <img src="../img/empresa.png" alt="empresa" >
            </a>
          </div>
         
          <div class="col-xs-6 col-md-3">
            <a href="cadastrar_empresa.php"  class="thumbnail" >
             <h5>Adicionar empresa</h5>
              <img src="../img/cadastrar.png" alt="empresa" >
            </a>
          </div>
          ...
          <div class="col-xs-6 col-md-3">
            <a href="visualizar_empresa.php"  class="thumbnail" >
             <h5>Editar empresa</h5>
              <img src="../img/editar.png" alt="empresa" >
            </a>
          </div>
        
          <div class="col-xs-6 col-md-3" >
            <a href="visualizar_empresa.php"  class="thumbnail" >
             <h5>Remover empresa</h5>
              <img src="../img/remover.png" alt="empresa" >
            </a>
          </div>
        </div>
    </div>
