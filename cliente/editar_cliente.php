      ...
      <div class="container">
        <table class="table">
          ...
          <?php
              ...
              $query = "SELECT nome, telefone, endereco, referencia, nascimento FROM clientes  WHERE telefone = '$telefone'";
              $result = mysql_query($query, $conecta);
                  ...
                  while( $consulta = mysql_fetch_array($result)){
                    ...
                    print "<td><input type='text' value='$consulta[referencia]'name='referencia'/> </td>";
                    print "<td><input type='date' value='$consulta[nascimento]'name='nascimento'/> </td>";
