<?php
    ...
    $selecao = mysql_query($sql, $conecta);
            ...
            <div class="col-xs-12 col-md-12">
               <table class="table table-hover">
                 <thead>
                   ...
                   <th style="background-color:orange;">Atualizar</th>
                 </thead>
                 <tbody>
                 <form method="POST" action="editarEntregadorFinal.php">
                   <?
                      while ($consulta = mysql_fetch_array($selecao)) {
                         print "<td><input type='text' value='$consulta[nome]' name='nome'/></td>";
                         print "<td><input type='text' value='$consulta[cpf]' name='cpf'/></td>";
                         print "<td><input type='text' value='$consulta[telefone]' name='telefone'/></td>";
                         print "<td><input type='text' value='$consulta[empresa]' name='empresa'/></td>";
                         print "<td><input type='submit' class='btn btn-warning' value='Atualizar'/></td>";
                      }
