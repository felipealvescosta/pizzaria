...
<html lang="pt-br">
  <head>
    ...
    <meta name="description" content="Sistema para pizzarias - entregador, pizzaria Maveana.">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="../entregador.php">entregadors</a></li>
    ...
    <br>
        <div class="page-header">
          <div class="row">
            <div class="col-xs-1 topo">
              <img src="../img/entrega.png" alt="Entregador" >
            </div>
            <div class="col-xs-11">
              <h2>Entregador</h2>
            </div>
        ...
        <div class="row">
          <div class="col-xs-6 col-md-3" >
            <a href="buscar_entregador.php"  class="thumbnail" >
             <h5>Buscar Entregador</h5>
              <img src="../img/buscar.png" alt="Entregador" >
            </a>
          </div>
          
           <div class="col-xs-6 col-md-3" >
            <a href="visualizar_entregador.php"  class="thumbnail" >
             <h5>Visualizar entregador</h5>
              <img src="../img/entrega.png" alt="entregadors" >
            </a>
          </div>
         
          <div class="col-xs-6 col-md-3">
            <a href="cadastrar_entregador.php"  class="thumbnail" >
             <h5>Adicionar entregador</h5>
              <img src="../img/cadastrar.png" alt="entregador" >
            </a>
          </div>
          ...
          <div class="col-xs-6 col-md-3">
            <a href="editar_entregador.php"  class="thumbnail" >
             <h5>Editar entregador</h5>
              <img src="../img/editar.png" alt="entregadors" >
            </a>
          </div>
        
          <div class="col-xs-6 col-md-3" >
            <a href="editar_entregador.php"  class="thumbnail" >
             <h5>Remover entregador</h5>
              <img src="../img/remover.png" alt="entregadors" >
            </a>
          </div>
        </div>
    </div>
