            ...
            <div class="col-xs-12 col-md-12">
               <table class="table table-hover">
                 <thead>
                   ...
                   <th>Empresa</th>
                   <th>Cadastro</th>
                   <th style="background-color:orange;">Editar</th>
                 ...
                 <tbody>
                   <?
                      while ($consulta = mysql_fetch_array($selecao)) {
                         ...
                         print "<td>$consulta[empresa]</td>";
                         print "<td>$consulta[cadastro]</td>";
                         print "<td><a class='btn btn-warning' href='editarEntregador.php?cpf=$consulta[cpf]'>Editar</a></td>";
                         print "<td><a class='btn btn-danger' href='removerEntregador.php?cpf=$consulta[cpf]'>Excluir</a></td>";
                          print "</tbody>";
                      }
