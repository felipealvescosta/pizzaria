  ...
  <body>
    ...
    <br>
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3" >
            <a href="visualizar_entrega.php"  class="thumbnail" >
             <h5>Visualizar Entrega</h5>
              <img src="../img/entrega.png" alt="pedido" >
            </a>
          </div>
    ...
    <footer class="footer">
      <div class="container">
        <hr>
        <p class="text-muted">
          <center>Sistema de gestão de pessoas e pedidos </br> UNOPAR 2015.2</center>
        </p>
      </div>
    </footer>
